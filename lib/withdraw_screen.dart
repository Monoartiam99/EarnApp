    ...
    return Padding(
      ...
      child: SizedBox(
        ...
        child: ElevatedButton(
          onPressed: isSubmitting ? null : () => requestWithdrawal(coins, amount),
  ...
  Widget historyCard(Map<String, dynamic> data) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text("₹$amount → $id ($method)", style: const TextStyle(fontWeight: FontWeight.bold)),
          const SizedBox(height: 6),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text("Coins: $coins", style: const TextStyle(color: Colors.deepPurple)),
              Container(
  ...
  Widget withdrawalHistory() {
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        if (docs.isEmpty) {
          return const Text("No withdrawals yet.", style: TextStyle(color: Colors.grey));
        }
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text("Choose Method",
                style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
            const SizedBox(height: 8),
            methodSelector(),
            const SizedBox(height: 20),

            Text(selectedMethod == "Google Play" ? "Enter Google Email" : "Enter UPI ID",
                style: const TextStyle(fontSize: 15)),
            const SizedBox(height: 6),
            TextField(
              controller: inputController,
              decoration: InputDecoration(
                hintText: selectedMethod == "Google Play" ? "example@gmail.com" : "example@upi",
                filled: true,
            ...
            const Text("Select Withdrawal Amount",
                style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
